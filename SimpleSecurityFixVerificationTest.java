 ...
 */
public class SimpleSecurityFixVerificationTest {
    ...
    public static void main(String[] args) {
        ...
        SimpleSecurityFixVerificationTest test = new SimpleSecurityFixVerificationTest();
    ...
    private void testCSPPolicy_SecurityHeaders() {
        ...
        assertFalse(cspPolicy.contains("unsafe-inline") && cspPolicy.contains("script-src"),
